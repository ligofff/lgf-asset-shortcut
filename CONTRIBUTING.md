...
1. Make an [Issue](https://github.com/ligofff/lgf-asset-shortcut/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-asset-shortcut": "https://github.com/YOUR_USER/lgf-asset-shortcut.git"
        }
    }
```
